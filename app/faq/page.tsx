...
import { INTRIHUB_FAQS } from "@/lib/data/faqs";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Frequently Asked Questions | IntriHub",
    description:
...
export default function FAQPage() {
  ...
  return (
    <>
      <JsonLd data={breadcrumbsSchema} id="faq-breadcrumbs-schema" />
      <JsonLd data={faqSchema} id="faq-page-schema" />
