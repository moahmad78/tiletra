...
export default function HelpDeskPage() {
    ...
    const checkSession = async () => {
      try {
        ...
        if (data.authenticated) {
          ...
          if (localAuth === "info@intrihub.com") {
            setIsAuthenticated(true);
          } else {
  ...
  // 2. Fetch Conversations when authenticated
  ...
  }, [isAuthenticated, selectedConvId, fetchConversationDetails]);

  // 4. Fetch AI Reply Suggestion
  ...
  // 5. Send Message (Agent to Customer)
  ...
  // 6. Decoupled Translation for Agent Draft
      ...
      <header className="h-16 bg-[#0a192f] border-b border-cyan-900/40 px-4 md:px-6 flex items-center justify-between z-20">
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-900/90 border border-slate-800 text-xs text-slate-300">
            ...
            <span className="font-mono text-cyan-300 font-medium">info@intrihub.com</span>
            <span className="text-slate-500">|</span>
            <span className="text-[11px] text-slate-400">Authorized Lead</span>
          </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center gap-2 pt-2">
                        ...
                        <button
                          onClick={() => {
                            setAgentDraftText(aiSuggestion.suggestedReply);
                            const composer = document.getElementById("help-composer-input");
                            composer?.focus();
                          }}
