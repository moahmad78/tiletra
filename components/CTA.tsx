    ...
    <section className="py-24 lg:py-32 bg-gradient-to-br from-[#052a51] to-[#022046] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center px-4">
        ...
        >
          ...
          <a href="tel:+917090120211" className="w-full sm:w-auto inline-flex items-center justify-center px-10 py-5 bg-transparent border border-white/30 text-white rounded-full font-bold text-lg hover:bg-white/10 hover:border-white/50 transition-all duration-500">
            Call +91 70901 20211
          </a>
        </motion.div>
