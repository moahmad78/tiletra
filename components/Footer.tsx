        ...
        <div className="w-full max-w-[1400px] mx-auto px-[20px] md:px-[24px] lg:px-[32px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
            ...
            <div className="lg:col-span-1 pr-4">
              ...
              {/* Founder Tag */}
              <div className="p-3 rounded-2xl bg-white/[0.04] border border-white/10 mb-5 space-y-1">
                <p className="text-[11px] font-bold text-white uppercase tracking-wider flex items-center gap-1.5">
                  ...
                  Founded & Built by Sahil Sheikh
                </p>
                <a
                  href="https://www.instagram.com/sahil_sheikh78/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs text-[#F26522] hover:text-white font-semibold transition-colors flex items-center gap-1.5"
                >
                  ...
                  <span>@sahil_sheikh78 (Instagram)</span>
                </a>
              </div>
              ...
              <div className="flex gap-3">
                <a
                  ...
                  aria-label="Instagram @sahil_sheikh78"
                  title="Follow Sahil Sheikh on Instagram @sahil_sheikh78"
                >
                ...
                <a
                  ...
                  aria-label="WhatsApp Sahil Sheikh"
                  title="WhatsApp Founder & CEO Sahil Sheikh"
                >
          ...
          <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-white/50">
            ...
            <p className="flex items-center gap-1.5 flex-wrap justify-center">
              ...
              >
                ...
                <span className="text-[#F26522] font-bold">(@sahil_sheikh78)</span>
              </a>
            </p>
          </div>
        </div>
