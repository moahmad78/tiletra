    ...
    "@graph": [
      {
        ...
        knowsAbout: [
          ...
          "Hardware Store Digital Transformation",
          "Vitrified Tiles and Granite Supply",
          "Electrical Wires and Plumbing Systems",
          "Indian Retail Modernization",
...
export function generateOrganizationSchema() {
  return {
    ...
    knowsAbout: [
      "Digitalizing Local Markets",
      "Building Materials Quick Commerce",
      "Hardware Store Digital Transformation",
    ...
    founder: {
      ...
      description:
        "23-year-old visionary software engineer and entrepreneur from Uttar Pradesh, who founded Intrihub to digitalize India's local trade and take Indian commerce to the global stage.",
    },
    sameAs: [
      "https://www.instagram.com/intrihub_/",
      "https://www.linkedin.com/company/intrihub",
