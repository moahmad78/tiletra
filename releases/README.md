...
* **File Name:** `IntriHub-Customer-v1.1.6(9).aab`
* **Full Local Path:** `d:\Intrihub\releases\IntriHub-Customer-v1.1.6(9).aab`
* **Version Name:** `1.1.6`
* **Version Code:** `9`
...
```text
• Introduced interactive New User Walkthrough for smooth onboarding and feature discovery.
• Added smart Exit Confirmation dialog to prevent accidental app closures during shopping.
• Integrated seamless In-App Play Store Rating prompt for customer satisfaction and feedback.
• Upgraded core React Native & Hermes engine performance for ultra-fast checkout and product browsing.
• Full native compatibility enhancements for Android 12, 13, 14, and 15 (API 35).
```
