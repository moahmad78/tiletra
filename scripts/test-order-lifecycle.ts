...
async function main() {
  ...
  const failedOrderRes = await createOrder({
    ...
    shippingAddress: { street: "123 Test St", city: "Bangalore", state: "Karnataka", pincode: "560001" },
    subtotal: 30000,
    deliveryFee: 0,
    discount: 0,
    total: 30000,
  ...
  const orderRes = await createOrder({
    ...
    shippingAddress: { street: "45 MG Road", city: "Bangalore", state: "Karnataka", pincode: "560001" },
    subtotal: 2400,
    deliveryFee: 0,
    discount: 0,
    total: 2400,
